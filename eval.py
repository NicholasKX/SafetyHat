...
# some paths
parser.add_argument("--eval_file", type=str, default="./data/my_data/label/val.txt",
                    help="The path of the validation or test txt file.")

parser.add_argument("--restore_path", type=str, default="./checkpoint/model-epoch_40_step_38867_loss_2.1664_lr_3e-05", #./data/darknet_weights/yolov3.ckpt
